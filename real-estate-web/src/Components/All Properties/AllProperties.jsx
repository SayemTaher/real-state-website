...
const AllProperties = () => {
    ...
    return (
        <div>
            <Helmet>
                <title>Douglas | All Properties</title>
            </Helmet>
            ...
            <div className="mt-20" data-aos="fade-in">
                <h1 className="text-2xl lg:text-5xl text-primaryOlive md:text-4xl animate__animated animate__bounce font-bold">All Properties</h1>
